...
from src.dialogs.users.messages import CHOOSE_USER_TYPE_MESSAGE
...
async def get_choose_user_types_data(
    ...
    user_types = await uow.users.get_user_types()
    return {"user_types": user_types, "name": dialog_manager.dialog_data["name"]}
